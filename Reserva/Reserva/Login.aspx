<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Reserva.Login" %>
    ...
    <form id="form1" runat="server">
        <div class="container bg-light mt-5">
            ...
            <h1>Login</h1>
                ...
                <asp:LinkButton ID="lbsiguiente" runat="server" PostBackUrl="~/Registro.aspx">Ir al registro</asp:LinkButton>
                  <br />
